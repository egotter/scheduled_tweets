...
ActiveRecord::Schema.define(version: 2020_01_19_093043) do
  ...
  create_table "scheduled_tweets", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "tweet_id"
    t.text "text"
    t.json "properties"
